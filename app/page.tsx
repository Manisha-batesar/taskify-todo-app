          ...
          {isAuthenticated ? (
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  <Avatar className="w-12 h-12">
                    ...
                    <AvatarFallback className="bg-[var(--taskify-content)] text-white font-semibold">DN</AvatarFallback>
                  </Avatar>
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-[var(--taskify-text-primary)]">Denise</h3>
                  <p className="text-sm text-[var(--taskify-text-secondary)]">denise@taskify.com</p>
                </div>
              </div>
              <Button
                variant="outline"
            ...
            <div className="space-y-3">
              <div className="text-center">
                <h3 className="font-semibold text-[var(--taskify-text-primary)] mb-2">Welcome to Taskify</h3>
                <p className="text-sm text-[var(--taskify-text-secondary)] mb-4">Sign in to manage your tasks</p>
              </div>
              <Button
                onClick={() => setShowSignIn(true)}
                className="w-full bg-[var(--taskify-content)] hover:bg-[var(--taskify-accent)] text-white"
              >
              ...
              <Button
                ...
                variant="outline"
                className="w-full border-[var(--taskify-content)] text-[var(--taskify-content)] hover:bg-[var(--taskify-content)] hover:text-white"
              >
            ...
            <div className="flex items-center gap-4">
              ...
              {isAuthenticated && (
                <Avatar className="w-8 h-8">
                  <AvatarImage src="/professional-person.png" />
                  <AvatarFallback className="bg-[var(--taskify-content)] text-white text-sm">DN</AvatarFallback>
                </Avatar>
              )}
            </div>
          </div>
